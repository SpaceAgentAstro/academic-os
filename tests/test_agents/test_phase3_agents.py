...
def test_write_markscheme_entry_directly(ms_db, qb_db):
    ...
    # Construct a MarkEntry to validate the dataclass contract used by the agent.
    MarkEntry(sequence=1, mark_type="M", marks_value=1, description="Rearrange the equation.")
    ms_db.execute(
